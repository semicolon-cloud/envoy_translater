...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_REGEXMATCHER_GOOGLERE2'].fields_by_name['max_program_size']._options = None
  ...
  _globals['_REGEXMATCHANDSUBSTITUTE']._options = None
