...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_PRIVATEKEYPROVIDER'].fields_by_name['config']._options = None
  ...
  _globals['_CERTIFICATEVALIDATIONCONTEXT'].fields_by_name['verify_subject_alt_name']._options = None
