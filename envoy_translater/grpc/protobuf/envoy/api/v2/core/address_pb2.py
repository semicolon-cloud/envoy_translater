...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_PIPE'].fields_by_name['path']._options = None
  _globals['_PIPE'].fields_by_name['path']._serialized_options = b'\372B\004r\002 \001'
  _globals['_PIPE'].fields_by_name['mode']._options = None
  _globals['_PIPE'].fields_by_name['mode']._serialized_options = b'\372B\005*\003\030\377\003'
  _globals['_SOCKETADDRESS'].oneofs_by_name['port_specifier']._options = None
  _globals['_SOCKETADDRESS'].oneofs_by_name['port_specifier']._serialized_options = b'\370B\001'
  _globals['_SOCKETADDRESS'].fields_by_name['protocol']._options = None
  _globals['_SOCKETADDRESS'].fields_by_name['protocol']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_SOCKETADDRESS'].fields_by_name['address']._options = None
  _globals['_SOCKETADDRESS'].fields_by_name['address']._serialized_options = b'\372B\004r\002 \001'
  _globals['_SOCKETADDRESS'].fields_by_name['port_value']._options = None
  _globals['_SOCKETADDRESS'].fields_by_name['port_value']._serialized_options = b'\372B\006*\004\030\377\377\003'
  _globals['_BINDCONFIG'].fields_by_name['source_address']._options = None
  _globals['_BINDCONFIG'].fields_by_name['source_address']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_ADDRESS'].oneofs_by_name['address']._options = None
  _globals['_ADDRESS'].oneofs_by_name['address']._serialized_options = b'\370B\001'
  _globals['_CIDRRANGE'].fields_by_name['address_prefix']._options = None
  _globals['_CIDRRANGE'].fields_by_name['address_prefix']._serialized_options = b'\372B\004r\002 \001'
  _globals['_CIDRRANGE'].fields_by_name['prefix_len']._options = None
