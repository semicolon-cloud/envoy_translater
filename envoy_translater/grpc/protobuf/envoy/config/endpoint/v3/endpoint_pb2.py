...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_CLUSTERLOADASSIGNMENT_POLICY_DROPOVERLOAD'].fields_by_name['category']._options = None
  _globals['_CLUSTERLOADASSIGNMENT_POLICY_DROPOVERLOAD'].fields_by_name['category']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_CLUSTERLOADASSIGNMENT_POLICY_DROPOVERLOAD']._options = None
  ...
  _globals['_CLUSTERLOADASSIGNMENT_POLICY'].fields_by_name['overprovisioning_factor']._options = None
  _globals['_CLUSTERLOADASSIGNMENT_POLICY'].fields_by_name['overprovisioning_factor']._serialized_options = b'\372B\004*\002 \000'
  _globals['_CLUSTERLOADASSIGNMENT_POLICY'].fields_by_name['endpoint_stale_after']._options = None
