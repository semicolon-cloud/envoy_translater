...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_LOCALRESPONSEPOLICY'].fields_by_name['status_code']._options = None
  _globals['_LOCALRESPONSEPOLICY'].fields_by_name['status_code']._serialized_options = b'\372B\010*\006\020\330\004(\310\001'
  _globals['_LOCALRESPONSEPOLICY'].fields_by_name['response_headers_to_add']._options = None
