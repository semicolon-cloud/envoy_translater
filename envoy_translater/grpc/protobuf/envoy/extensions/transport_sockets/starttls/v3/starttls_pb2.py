...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_STARTTLSCONFIG'].fields_by_name['tls_socket_config']._options = None
  _globals['_STARTTLSCONFIG'].fields_by_name['tls_socket_config']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_UPSTREAMSTARTTLSCONFIG'].fields_by_name['tls_socket_config']._options = None
