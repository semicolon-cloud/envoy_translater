...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_QUICDOWNSTREAMTRANSPORT'].fields_by_name['downstream_tls_context']._options = None
  ...
  _globals['_QUICUPSTREAMTRANSPORT'].fields_by_name['upstream_tls_context']._options = None
