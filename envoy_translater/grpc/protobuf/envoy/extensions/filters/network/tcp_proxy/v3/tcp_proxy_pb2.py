...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_TCPPROXY_WEIGHTEDCLUSTER_CLUSTERWEIGHT'].fields_by_name['name']._options = None
  _globals['_TCPPROXY_WEIGHTEDCLUSTER_CLUSTERWEIGHT'].fields_by_name['name']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_TCPPROXY_WEIGHTEDCLUSTER_CLUSTERWEIGHT'].fields_by_name['weight']._options = None
  _globals['_TCPPROXY_WEIGHTEDCLUSTER_CLUSTERWEIGHT'].fields_by_name['weight']._serialized_options = b'\372B\004*\002(\001'
  _globals['_TCPPROXY_WEIGHTEDCLUSTER_CLUSTERWEIGHT']._options = None
  ...
  _globals['_TCPPROXY_WEIGHTEDCLUSTER'].fields_by_name['clusters']._options = None
  _globals['_TCPPROXY_WEIGHTEDCLUSTER'].fields_by_name['clusters']._serialized_options = b'\372B\005\222\001\002\010\001'
  _globals['_TCPPROXY_WEIGHTEDCLUSTER']._options = None
  ...
  _globals['_TCPPROXY_TCPACCESSLOGOPTIONS'].fields_by_name['access_log_flush_interval']._options = None
  ...
  _globals['_TCPPROXY'].fields_by_name['access_log_flush_interval']._options = None
  ...
  _globals['_TCPPROXY'].fields_by_name['flush_access_log_on_connected']._options = None
  _globals['_TCPPROXY'].fields_by_name['flush_access_log_on_connected']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_TCPPROXY']._options = None
  _globals['_TCPPROXY']._serialized_options = b'\232\305\210\0363\n1envoy.config.filter.network.tcp_proxy.v2.TcpProxy'
  _globals['_TCPPROXY']._serialized_start=456
  _globals['_TCPPROXY']._serialized_end=2650
  _globals['_TCPPROXY_WEIGHTEDCLUSTER']._serialized_start=1541
  _globals['_TCPPROXY_WEIGHTEDCLUSTER']._serialized_end=1957
  _globals['_TCPPROXY_WEIGHTEDCLUSTER_CLUSTERWEIGHT']._serialized_start=1676
  _globals['_TCPPROXY_WEIGHTEDCLUSTER_CLUSTERWEIGHT']._serialized_end=1883
  _globals['_TCPPROXY_TUNNELINGCONFIG']._serialized_start=1960
  _globals['_TCPPROXY_TUNNELINGCONFIG']._serialized_end=2264
  _globals['_TCPPROXY_ONDEMAND']._serialized_start=2267
  _globals['_TCPPROXY_ONDEMAND']._serialized_end=2406
  _globals['_TCPPROXY_TCPACCESSLOGOPTIONS']._serialized_start=2409
  _globals['_TCPPROXY_TCPACCESSLOGOPTIONS']._serialized_end=2545
