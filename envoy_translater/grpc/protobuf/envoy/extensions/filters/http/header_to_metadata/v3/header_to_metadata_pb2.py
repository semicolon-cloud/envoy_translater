...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_CONFIG_RULE'].fields_by_name['header']._options = None
  ...
  _globals['_CONFIG_RULE'].fields_by_name['cookie']._options = None
