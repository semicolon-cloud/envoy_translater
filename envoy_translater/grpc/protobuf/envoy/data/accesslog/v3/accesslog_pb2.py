...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_TCPACCESSLOGENTRY']._options = None
  _globals['_TCPACCESSLOGENTRY']._serialized_options = b'\232\305\210\036+\n)envoy.data.accesslog.v2.TCPAccessLogEntry'
  _globals['_HTTPACCESSLOGENTRY']._options = None
  _globals['_HTTPACCESSLOGENTRY']._serialized_options = b'\232\305\210\036,\n*envoy.data.accesslog.v2.HTTPAccessLogEntry'
  _globals['_CONNECTIONPROPERTIES']._options = None
  _globals['_CONNECTIONPROPERTIES']._serialized_options = b'\232\305\210\036.\n,envoy.data.accesslog.v2.ConnectionProperties'
  _globals['_ACCESSLOGCOMMON_FILTERSTATEOBJECTSENTRY']._options = None
  _globals['_ACCESSLOGCOMMON_FILTERSTATEOBJECTSENTRY']._serialized_options = b'8\001'
  _globals['_ACCESSLOGCOMMON_CUSTOMTAGSENTRY']._options = None
  _globals['_ACCESSLOGCOMMON_CUSTOMTAGSENTRY']._serialized_options = b'8\001'
  _globals['_ACCESSLOGCOMMON'].fields_by_name['sample_rate']._options = None
  ...
  _globals['_ACCESSLOGCOMMON'].fields_by_name['intermediate_log_entry']._options = None
  _globals['_ACCESSLOGCOMMON'].fields_by_name['intermediate_log_entry']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_ACCESSLOGCOMMON']._options = None
  _globals['_ACCESSLOGCOMMON']._serialized_options = b'\232\305\210\036)\n\'envoy.data.accesslog.v2.AccessLogCommon'
  _globals['_RESPONSEFLAGS_UNAUTHORIZED']._options = None
  _globals['_RESPONSEFLAGS_UNAUTHORIZED']._serialized_options = b'\232\305\210\0364\n2envoy.data.accesslog.v2.ResponseFlags.Unauthorized'
  _globals['_RESPONSEFLAGS']._options = None
  _globals['_RESPONSEFLAGS']._serialized_options = b'\232\305\210\036\'\n%envoy.data.accesslog.v2.ResponseFlags'
  _globals['_TLSPROPERTIES_CERTIFICATEPROPERTIES_SUBJECTALTNAME']._options = None
  _globals['_TLSPROPERTIES_CERTIFICATEPROPERTIES_SUBJECTALTNAME']._serialized_options = b'\232\305\210\036L\nJenvoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName'
  _globals['_TLSPROPERTIES_CERTIFICATEPROPERTIES']._options = None
  _globals['_TLSPROPERTIES_CERTIFICATEPROPERTIES']._serialized_options = b'\232\305\210\036=\n;envoy.data.accesslog.v2.TLSProperties.CertificateProperties'
  _globals['_TLSPROPERTIES']._options = None
  _globals['_TLSPROPERTIES']._serialized_options = b'\232\305\210\036\'\n%envoy.data.accesslog.v2.TLSProperties'
  _globals['_HTTPREQUESTPROPERTIES_REQUESTHEADERSENTRY']._options = None
  _globals['_HTTPREQUESTPROPERTIES_REQUESTHEADERSENTRY']._serialized_options = b'8\001'
  _globals['_HTTPREQUESTPROPERTIES'].fields_by_name['request_method']._options = None
  _globals['_HTTPREQUESTPROPERTIES'].fields_by_name['request_method']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_HTTPREQUESTPROPERTIES']._options = None
  _globals['_HTTPREQUESTPROPERTIES']._serialized_options = b'\232\305\210\036/\n-envoy.data.accesslog.v2.HTTPRequestProperties'
  _globals['_HTTPRESPONSEPROPERTIES_RESPONSEHEADERSENTRY']._options = None
  _globals['_HTTPRESPONSEPROPERTIES_RESPONSEHEADERSENTRY']._serialized_options = b'8\001'
  _globals['_HTTPRESPONSEPROPERTIES_RESPONSETRAILERSENTRY']._options = None
  _globals['_HTTPRESPONSEPROPERTIES_RESPONSETRAILERSENTRY']._serialized_options = b'8\001'
  _globals['_HTTPRESPONSEPROPERTIES']._options = None
  _globals['_HTTPRESPONSEPROPERTIES']._serialized_options = b'\232\305\210\0360\n.envoy.data.accesslog.v2.HTTPResponseProperties'
  _globals['_ACCESSLOGTYPE']._serialized_start=6496
  _globals['_ACCESSLOGTYPE']._serialized_end=6827
  ...
  _globals['_RESPONSEFLAGS']._serialized_end=4325
  _globals['_RESPONSEFLAGS_UNAUTHORIZED']._serialized_start=4074
  _globals['_RESPONSEFLAGS_UNAUTHORIZED']._serialized_end=4279
  _globals['_RESPONSEFLAGS_UNAUTHORIZED_REASON']._serialized_start=4166
  _globals['_RESPONSEFLAGS_UNAUTHORIZED_REASON']._serialized_end=4220
  _globals['_TLSPROPERTIES']._serialized_start=4328
  _globals['_TLSPROPERTIES']._serialized_end=5249
  _globals['_TLSPROPERTIES_CERTIFICATEPROPERTIES']._serialized_start=4748
  _globals['_TLSPROPERTIES_CERTIFICATEPROPERTIES']._serialized_end=5114
  _globals['_TLSPROPERTIES_CERTIFICATEPROPERTIES_SUBJECTALTNAME']._serialized_start=4910
  _globals['_TLSPROPERTIES_CERTIFICATEPROPERTIES_SUBJECTALTNAME']._serialized_end=5046
  _globals['_TLSPROPERTIES_TLSVERSION']._serialized_start=5116
  _globals['_TLSPROPERTIES_TLSVERSION']._serialized_end=5203
  _globals['_HTTPREQUESTPROPERTIES']._serialized_start=5252
  _globals['_HTTPREQUESTPROPERTIES']._serialized_end=5881
  _globals['_HTTPREQUESTPROPERTIES_REQUESTHEADERSENTRY']._serialized_start=5774
  _globals['_HTTPREQUESTPROPERTIES_REQUESTHEADERSENTRY']._serialized_end=5827
  _globals['_HTTPRESPONSEPROPERTIES']._serialized_start=5884
  _globals['_HTTPRESPONSEPROPERTIES']._serialized_end=6493
  _globals['_HTTPRESPONSEPROPERTIES_RESPONSEHEADERSENTRY']._serialized_start=6327
  _globals['_HTTPRESPONSEPROPERTIES_RESPONSEHEADERSENTRY']._serialized_end=6381
  _globals['_HTTPRESPONSEPROPERTIES_RESPONSETRAILERSENTRY']._serialized_start=6383
  _globals['_HTTPRESPONSEPROPERTIES_RESPONSETRAILERSENTRY']._serialized_end=6438
