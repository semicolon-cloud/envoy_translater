...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_HTTPPROTOCOLOPTIONS_EXPLICITHTTPCONFIG'].oneofs_by_name['protocol_config']._options = None
  _globals['_HTTPPROTOCOLOPTIONS_EXPLICITHTTPCONFIG'].oneofs_by_name['protocol_config']._serialized_options = b'\370B\001'
  _globals['_HTTPPROTOCOLOPTIONS'].oneofs_by_name['upstream_protocol_options']._options = None
