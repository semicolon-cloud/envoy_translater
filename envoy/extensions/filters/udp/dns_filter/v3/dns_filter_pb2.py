...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_DNSFILTERCONFIG_SERVERCONTEXTCONFIG'].oneofs_by_name['config_source']._options = None
  _globals['_DNSFILTERCONFIG_SERVERCONTEXTCONFIG'].oneofs_by_name['config_source']._serialized_options = b'\370B\001'
  _globals['_DNSFILTERCONFIG_CLIENTCONTEXTCONFIG'].fields_by_name['resolver_timeout']._options = None
  ...
  _globals['_DNSFILTERCONFIG_CLIENTCONTEXTCONFIG'].fields_by_name['upstream_resolvers']._options = None
  ...
  _globals['_DNSFILTERCONFIG_CLIENTCONTEXTCONFIG'].fields_by_name['dns_resolution_config']._options = None
  ...
  _globals['_DNSFILTERCONFIG_CLIENTCONTEXTCONFIG'].fields_by_name['max_pending_lookups']._options = None
  _globals['_DNSFILTERCONFIG_CLIENTCONTEXTCONFIG'].fields_by_name['max_pending_lookups']._serialized_options = b'\372B\0042\002(\001'
  _globals['_DNSFILTERCONFIG'].fields_by_name['stat_prefix']._options = None
