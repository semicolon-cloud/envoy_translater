...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_GRADIENTCONTROLLERCONFIG_CONCURRENCYLIMITCALCULATIONPARAMS'].fields_by_name['max_concurrency_limit']._options = None
  ...
  _globals['_GRADIENTCONTROLLERCONFIG_CONCURRENCYLIMITCALCULATIONPARAMS'].fields_by_name['concurrency_update_interval']._options = None
  ...
  _globals['_GRADIENTCONTROLLERCONFIG_CONCURRENCYLIMITCALCULATIONPARAMS']._options = None
  ...
  _globals['_GRADIENTCONTROLLERCONFIG_MINIMUMRTTCALCULATIONPARAMS'].fields_by_name['interval']._options = None
  ...
  _globals['_GRADIENTCONTROLLERCONFIG_MINIMUMRTTCALCULATIONPARAMS'].fields_by_name['request_count']._options = None
  ...
  _globals['_GRADIENTCONTROLLERCONFIG_MINIMUMRTTCALCULATIONPARAMS'].fields_by_name['min_concurrency']._options = None
  ...
  _globals['_GRADIENTCONTROLLERCONFIG_MINIMUMRTTCALCULATIONPARAMS']._options = None
  ...
  _globals['_GRADIENTCONTROLLERCONFIG'].fields_by_name['concurrency_limit_params']._options = None
  ...
  _globals['_GRADIENTCONTROLLERCONFIG'].fields_by_name['min_rtt_calc_params']._options = None
  _globals['_GRADIENTCONTROLLERCONFIG'].fields_by_name['min_rtt_calc_params']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_GRADIENTCONTROLLERCONFIG']._options = None
  ...
  _globals['_ADAPTIVECONCURRENCY'].oneofs_by_name['concurrency_controller_config']._options = None
  _globals['_ADAPTIVECONCURRENCY'].oneofs_by_name['concurrency_controller_config']._serialized_options = b'\370B\001'
  _globals['_ADAPTIVECONCURRENCY'].fields_by_name['gradient_controller_config']._options = None
  ...
  _globals['_ADAPTIVECONCURRENCY']._options = None
