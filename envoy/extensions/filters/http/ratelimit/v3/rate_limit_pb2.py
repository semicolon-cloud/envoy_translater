...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_RATELIMIT'].fields_by_name['domain']._options = None
  ...
  _globals['_RATELIMIT'].fields_by_name['request_type']._options = None
  ...
  _globals['_RATELIMITCONFIG_ACTION_REQUESTHEADERS'].fields_by_name['header_name']._options = None
  _globals['_RATELIMITCONFIG_ACTION_REQUESTHEADERS'].fields_by_name['header_name']._serialized_options = b'\372B\nr\010\020\001\300\001\001\310\001\000'
  _globals['_RATELIMITCONFIG_ACTION_REQUESTHEADERS'].fields_by_name['descriptor_key']._options = None
  _globals['_RATELIMITCONFIG_ACTION_REQUESTHEADERS'].fields_by_name['descriptor_key']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_RATELIMITCONFIG_ACTION_GENERICKEY'].fields_by_name['descriptor_value']._options = None
  _globals['_RATELIMITCONFIG_ACTION_GENERICKEY'].fields_by_name['descriptor_value']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_RATELIMITCONFIG_ACTION_HEADERVALUEMATCH'].fields_by_name['descriptor_value']._options = None
  _globals['_RATELIMITCONFIG_ACTION_HEADERVALUEMATCH'].fields_by_name['descriptor_value']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_RATELIMITCONFIG_ACTION_HEADERVALUEMATCH'].fields_by_name['headers']._options = None
  _globals['_RATELIMITCONFIG_ACTION_HEADERVALUEMATCH'].fields_by_name['headers']._serialized_options = b'\372B\005\222\001\002\010\001'
  _globals['_RATELIMITCONFIG_ACTION_METADATA'].fields_by_name['descriptor_key']._options = None
  _globals['_RATELIMITCONFIG_ACTION_METADATA'].fields_by_name['descriptor_key']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_RATELIMITCONFIG_ACTION_METADATA'].fields_by_name['metadata_key']._options = None
  _globals['_RATELIMITCONFIG_ACTION_METADATA'].fields_by_name['metadata_key']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_RATELIMITCONFIG_ACTION_METADATA'].fields_by_name['source']._options = None
  _globals['_RATELIMITCONFIG_ACTION_METADATA'].fields_by_name['source']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_RATELIMITCONFIG_ACTION'].oneofs_by_name['action_specifier']._options = None
  _globals['_RATELIMITCONFIG_ACTION'].oneofs_by_name['action_specifier']._serialized_options = b'\370B\001'
  _globals['_RATELIMITCONFIG_OVERRIDE_DYNAMICMETADATA'].fields_by_name['metadata_key']._options = None
  _globals['_RATELIMITCONFIG_OVERRIDE_DYNAMICMETADATA'].fields_by_name['metadata_key']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_RATELIMITCONFIG_OVERRIDE'].oneofs_by_name['override_specifier']._options = None
  _globals['_RATELIMITCONFIG_OVERRIDE'].oneofs_by_name['override_specifier']._serialized_options = b'\370B\001'
  _globals['_RATELIMITCONFIG'].fields_by_name['stage']._options = None
  _globals['_RATELIMITCONFIG'].fields_by_name['stage']._serialized_options = b'\372B\004*\002\030\n'
  _globals['_RATELIMITCONFIG'].fields_by_name['actions']._options = None
  _globals['_RATELIMITCONFIG'].fields_by_name['actions']._serialized_options = b'\372B\005\222\001\002\010\001'
  _globals['_RATELIMITPERROUTE'].fields_by_name['vh_rate_limits']._options = None
  _globals['_RATELIMITPERROUTE'].fields_by_name['vh_rate_limits']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_RATELIMITPERROUTE'].fields_by_name['override_option']._options = None
