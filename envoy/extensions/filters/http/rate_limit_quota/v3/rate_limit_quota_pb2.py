...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_RATELIMITQUOTAFILTERCONFIG'].fields_by_name['rlqs_server']._options = None
  _globals['_RATELIMITQUOTAFILTERCONFIG'].fields_by_name['rlqs_server']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_RATELIMITQUOTAFILTERCONFIG'].fields_by_name['domain']._options = None
  _globals['_RATELIMITQUOTAFILTERCONFIG'].fields_by_name['domain']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_RATELIMITQUOTAFILTERCONFIG'].fields_by_name['bucket_matchers']._options = None
  _globals['_RATELIMITQUOTAFILTERCONFIG'].fields_by_name['bucket_matchers']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_RATELIMITQUOTAFILTERCONFIG'].fields_by_name['request_headers_to_add_when_not_enforced']._options = None
  _globals['_RATELIMITQUOTAFILTERCONFIG'].fields_by_name['request_headers_to_add_when_not_enforced']._serialized_options = b'\372B\005\222\001\002\020\n'
  _globals['_RATELIMITQUOTABUCKETSETTINGS_NOASSIGNMENTBEHAVIOR'].oneofs_by_name['no_assignment_behavior']._options = None
  _globals['_RATELIMITQUOTABUCKETSETTINGS_NOASSIGNMENTBEHAVIOR'].oneofs_by_name['no_assignment_behavior']._serialized_options = b'\370B\001'
  _globals['_RATELIMITQUOTABUCKETSETTINGS_EXPIREDASSIGNMENTBEHAVIOR'].oneofs_by_name['expired_assignment_behavior']._options = None
  _globals['_RATELIMITQUOTABUCKETSETTINGS_EXPIREDASSIGNMENTBEHAVIOR'].oneofs_by_name['expired_assignment_behavior']._serialized_options = b'\370B\001'
  _globals['_RATELIMITQUOTABUCKETSETTINGS_EXPIREDASSIGNMENTBEHAVIOR'].fields_by_name['expired_assignment_behavior_timeout']._options = None
  _globals['_RATELIMITQUOTABUCKETSETTINGS_EXPIREDASSIGNMENTBEHAVIOR'].fields_by_name['expired_assignment_behavior_timeout']._serialized_options = b'\372B\005\252\001\002*\000'
  _globals['_RATELIMITQUOTABUCKETSETTINGS_DENYRESPONSESETTINGS'].fields_by_name['response_headers_to_add']._options = None
  _globals['_RATELIMITQUOTABUCKETSETTINGS_DENYRESPONSESETTINGS'].fields_by_name['response_headers_to_add']._serialized_options = b'\372B\005\222\001\002\020\n'
  _globals['_RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER_VALUEBUILDER'].oneofs_by_name['value_specifier']._options = None
  _globals['_RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER_VALUEBUILDER'].oneofs_by_name['value_specifier']._serialized_options = b'\370B\001'
  _globals['_RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER_BUCKETIDBUILDERENTRY']._options = None
  _globals['_RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER_BUCKETIDBUILDERENTRY']._serialized_options = b'8\001'
  _globals['_RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER'].fields_by_name['bucket_id_builder']._options = None
  _globals['_RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER'].fields_by_name['bucket_id_builder']._serialized_options = b'\372B\005\232\001\002\010\001'
  _globals['_RATELIMITQUOTABUCKETSETTINGS'].fields_by_name['reporting_interval']._options = None
  _globals['_RATELIMITQUOTABUCKETSETTINGS'].fields_by_name['reporting_interval']._serialized_options = b'\372B\014\252\001\t\010\001*\005\020\200\302\327/'
