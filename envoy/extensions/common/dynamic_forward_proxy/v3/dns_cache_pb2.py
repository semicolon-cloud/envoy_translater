...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_DNSCACHECONFIG'].fields_by_name['name']._options = None
  _globals['_DNSCACHECONFIG'].fields_by_name['name']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_DNSCACHECONFIG'].fields_by_name['dns_lookup_family']._options = None
  _globals['_DNSCACHECONFIG'].fields_by_name['dns_lookup_family']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_DNSCACHECONFIG'].fields_by_name['dns_refresh_rate']._options = None
  _globals['_DNSCACHECONFIG'].fields_by_name['dns_refresh_rate']._serialized_options = b'\372B\t\252\001\0062\004\020\300\204='
  _globals['_DNSCACHECONFIG'].fields_by_name['dns_min_refresh_rate']._options = None
  _globals['_DNSCACHECONFIG'].fields_by_name['dns_min_refresh_rate']._serialized_options = b'\372B\007\252\001\0042\002\010\005'
  _globals['_DNSCACHECONFIG'].fields_by_name['host_ttl']._options = None
  _globals['_DNSCACHECONFIG'].fields_by_name['host_ttl']._serialized_options = b'\372B\005\252\001\002*\000'
  _globals['_DNSCACHECONFIG'].fields_by_name['max_hosts']._options = None
  _globals['_DNSCACHECONFIG'].fields_by_name['max_hosts']._serialized_options = b'\372B\004*\002 \000'
  _globals['_DNSCACHECONFIG'].fields_by_name['use_tcp_for_dns_lookups']._options = None
  _globals['_DNSCACHECONFIG'].fields_by_name['use_tcp_for_dns_lookups']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_DNSCACHECONFIG'].fields_by_name['dns_resolution_config']._options = None
  _globals['_DNSCACHECONFIG'].fields_by_name['dns_resolution_config']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_DNSCACHECONFIG'].fields_by_name['dns_query_timeout']._options = None
  _globals['_DNSCACHECONFIG'].fields_by_name['dns_query_timeout']._serialized_options = b'\372B\005\252\001\002*\000'
  _globals['_DNSCACHECONFIG']._options = None
