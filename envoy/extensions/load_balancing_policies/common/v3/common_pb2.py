...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_LOCALITYLBCONFIG'].oneofs_by_name['locality_config_specifier']._options = None
  _globals['_LOCALITYLBCONFIG'].oneofs_by_name['locality_config_specifier']._serialized_options = b'\370B\001'
  _globals['_CONSISTENTHASHINGLBCONFIG'].fields_by_name['hash_balance_factor']._options = None
