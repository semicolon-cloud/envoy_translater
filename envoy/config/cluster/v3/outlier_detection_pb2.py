...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_OUTLIERDETECTION'].fields_by_name['enforcing_local_origin_success_rate']._options = None
  _globals['_OUTLIERDETECTION'].fields_by_name['enforcing_local_origin_success_rate']._serialized_options = b'\372B\004*\002\030d'
  _globals['_OUTLIERDETECTION'].fields_by_name['failure_percentage_threshold']._options = None
  _globals['_OUTLIERDETECTION'].fields_by_name['failure_percentage_threshold']._serialized_options = b'\372B\004*\002\030d'
  _globals['_OUTLIERDETECTION'].fields_by_name['enforcing_failure_percentage']._options = None
  _globals['_OUTLIERDETECTION'].fields_by_name['enforcing_failure_percentage']._serialized_options = b'\372B\004*\002\030d'
  _globals['_OUTLIERDETECTION'].fields_by_name['enforcing_failure_percentage_local_origin']._options = None
  ...
  _globals['_OUTLIERDETECTION'].fields_by_name['max_ejection_time']._options = None
  _globals['_OUTLIERDETECTION'].fields_by_name['max_ejection_time']._serialized_options = b'\372B\005\252\001\002*\000'
  _globals['_OUTLIERDETECTION']._options = None
  ...
  _globals['_OUTLIERDETECTION']._serialized_end=1922
