...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_FILTER'].fields_by_name['config']._options = None
  _globals['_FILTER'].fields_by_name['config']._serialized_options = b'\030\001'
  _globals['_FILTERCHAINMATCH_CONNECTIONSOURCETYPE'].values_by_name["LOCAL"]._options = None
  ...
  _globals['_FILTERCHAIN'].fields_by_name['tls_context']._options = None
  ...
  _globals['_LISTENERFILTER'].fields_by_name['config']._options = None
