...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_RATELIMITQUOTAUSAGEREPORTS_BUCKETQUOTAUSAGE'].fields_by_name['bucket_id']._options = None
  _globals['_RATELIMITQUOTAUSAGEREPORTS_BUCKETQUOTAUSAGE'].fields_by_name['bucket_id']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_RATELIMITQUOTAUSAGEREPORTS_BUCKETQUOTAUSAGE'].fields_by_name['time_elapsed']._options = None
  _globals['_RATELIMITQUOTAUSAGEREPORTS_BUCKETQUOTAUSAGE'].fields_by_name['time_elapsed']._serialized_options = b'\372B\007\252\001\004\010\001*\000'
  _globals['_RATELIMITQUOTAUSAGEREPORTS'].fields_by_name['domain']._options = None
  _globals['_RATELIMITQUOTAUSAGEREPORTS'].fields_by_name['domain']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_RATELIMITQUOTAUSAGEREPORTS'].fields_by_name['bucket_quota_usages']._options = None
  _globals['_RATELIMITQUOTAUSAGEREPORTS'].fields_by_name['bucket_quota_usages']._serialized_options = b'\372B\005\222\001\002\010\001'
  _globals['_RATELIMITQUOTARESPONSE_BUCKETACTION_QUOTAASSIGNMENTACTION'].fields_by_name['assignment_time_to_live']._options = None
  _globals['_RATELIMITQUOTARESPONSE_BUCKETACTION_QUOTAASSIGNMENTACTION'].fields_by_name['assignment_time_to_live']._serialized_options = b'\372B\005\252\001\0022\000'
  _globals['_RATELIMITQUOTARESPONSE_BUCKETACTION'].oneofs_by_name['bucket_action']._options = None
  _globals['_RATELIMITQUOTARESPONSE_BUCKETACTION'].oneofs_by_name['bucket_action']._serialized_options = b'\370B\001'
  _globals['_RATELIMITQUOTARESPONSE_BUCKETACTION'].fields_by_name['bucket_id']._options = None
  _globals['_RATELIMITQUOTARESPONSE_BUCKETACTION'].fields_by_name['bucket_id']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_RATELIMITQUOTARESPONSE'].fields_by_name['bucket_action']._options = None
  _globals['_RATELIMITQUOTARESPONSE'].fields_by_name['bucket_action']._serialized_options = b'\372B\005\222\001\002\010\001'
  _globals['_BUCKETID_BUCKETENTRY']._options = None
  _globals['_BUCKETID_BUCKETENTRY']._serialized_options = b'8\001'
  _globals['_BUCKETID'].fields_by_name['bucket']._options = None
  _globals['_BUCKETID'].fields_by_name['bucket']._serialized_options = b'\372B\021\232\001\016\010\001\"\004r\002\020\001*\004r\002\020\001'
